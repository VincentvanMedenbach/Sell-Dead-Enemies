...
namespace SellCorpses.Patches
{
    internal class CentipedePatch
    {
        ...
        public static void spawnDeadBody(CentipedeAI __instance)
        {
            ...
            GameObject gameObject = UnityEngine.Object.Instantiate(SellCorpsesBase.deadCentipede.spawnPrefab, __instance.transform.position, __instance.transform.rotation);
