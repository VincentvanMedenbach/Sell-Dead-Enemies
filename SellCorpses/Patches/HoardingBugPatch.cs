...
namespace SellCorpses.Patches
{
    internal class HoardingBugPatch
    {
        ...
        public static void spawnDeadBody(HoarderBugAI __instance)
        {
            ...
            GameObject gameObject = UnityEngine.Object.Instantiate(SellCorpsesBase.deadHoardingBug.spawnPrefab, __instance.transform.position, __instance.transform.rotation);
