...
namespace SellCorpses.Patches
{
    internal class BaboonHawkPatch
    {
        ...
        public static void spawnDeadBody(BaboonBirdAI __instance)
        {
            ...
            GameObject gameObject = UnityEngine.Object.Instantiate(SellCorpsesBase.deadBaboonHawk.spawnPrefab, __instance.transform.position, __instance.transform.rotation);
